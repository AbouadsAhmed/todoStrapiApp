...
const Paginator = ({
  ...
  return (
    <>
      <p className="text-gray-600 text-sm mx-3 text-center">
        page <span className=" font-semibold text-gray-900 mx-1">{page}</span>{" "}
        to
        <span className=" font-semibold text-gray-900 mx-1">
          {pageCount}
        </span>{" "}
        of
        <span className=" font-semibold text-gray-900 mx-1">{total}</span>{" "}
        records
      </p>
